...
for table_name in test:
    tmp_view = l.View(table_name+'_base').setFolder(OUTPUT_DIR).setExtensionRequired().setMessage('This is an autogenerated view created by python at '+str(dt.datetime.now().replace(microsecond=0).isoformat()))
